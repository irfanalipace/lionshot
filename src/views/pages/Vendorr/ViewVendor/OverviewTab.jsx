							...
							{vendorData?.vendor_billing_address?.map((row, index) => (
								<Box key={index}>
									...
									<Typography variant='body2' className='TextCapitalize'>
										...
										{vendorData?.vendor_billing_address[index]?.state?.name ||
											'N/A'}
										,
									...
									<Typography variant='body2' className='TextCapitalize'>
										{vendorData?.vendor_billing_address[index]?.country?.name ||
											'N/A'}
									</Typography>
								</Box>
							))}
							...
							{vendorData?.vendor_shipping_address?.map((row, index) => (
								<Box key={index} mt={2}>
									...
									<Typography variant='body2' className='TextCapitalize'>
										...
										{vendorData?.vendor_shipping_address[index]?.state?.name ||
											'N/A'}
										,
